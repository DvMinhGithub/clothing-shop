...
public class CartController {
    ...
    @Secured("CUSTOMER")
    @PutMapping("/update")
    public ResponseEntity<ResponseApi<?>> updateCartInformation(@RequestBody UpdateCartRequest updateCartRequest) {
        return cartService.updateCartInformation(updateCartRequest);
    }
}
